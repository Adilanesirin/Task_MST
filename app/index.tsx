  ...
  useEffect(() => {
    const initializeApp = async () => {
      try {
        ...
        // ✅ STEP 1: Check if license is activated
        ...
        // ✅ STEP 3: License is valid, check pairing status
        ...
        setTimeout(() => {
          if (ip && token) {
            console.log("✅ Fully authenticated - Redirecting to Main");
            setRedirectTo("/(main)/");
          } else {
            console.log("⚠️ Licensed but not paired - Redirecting to Pairing");
